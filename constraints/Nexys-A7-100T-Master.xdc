...
##Switches
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports en_i]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {r_i[0]}]
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports {r_i[1]}]
set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS33} [get_ports {r_i[2]}]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {r_i[3]}]
set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33} [get_ports {g_i[0]}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {g_i[1]}]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports {g_i[2]}]
set_property -dict {PACKAGE_PIN T8 IOSTANDARD LVCMOS18} [get_ports {g_i[3]}]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS18} [get_ports {b_i[0]}]
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {b_i[1]}]
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports {b_i[2]}]
set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS33} [get_ports {b_i[3]}]
...
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports hs_o]
set_property -dict {PACKAGE_PIN B12 IOSTANDARD LVCMOS33} [get_ports vs_o]
...
set_multicycle_path -setup -from [get_pins -hierarchical -filter { NAME =~  "*h_counter_reg[*]/C*" && NAME !~  "*CE*" && NAME !~  "*CLR*" }] -to [get_pins -hierarchical {*h_counter_reg[*]/D*}] 4
set_multicycle_path -hold -from [get_pins -hierarchical -filter { NAME =~  "*h_counter_reg[*]/C*" && NAME !~  "*CE*" && NAME !~  "*CLR*" }] -to [get_pins -hierarchical {*h_counter_reg[*]/D*}] 3
set_multicycle_path -setup -from [get_pins -hierarchical -filter { NAME =~  "*v_counter_reg[*]/C*" && NAME !~  "*CE*" && NAME !~  "*CLR*" }] -to [get_pins -hierarchical {*v_counter_reg[*]/D*}] 3200
set_multicycle_path -hold -from [get_pins -hierarchical -filter { NAME =~  "*v_counter_reg[*]/C*" && NAME !~  "*CE*" && NAME !~  "*CLR*" }] -to [get_pins -hierarchical {*v_counter_reg[*]/D*}] 3199